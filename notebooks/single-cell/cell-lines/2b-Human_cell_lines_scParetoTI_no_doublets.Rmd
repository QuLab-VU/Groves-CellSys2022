...
ElbowPlot(data) #this plot indicates  the top 10 are important
...
#1: 3   varexpl 0.4919459   0.001
# 2: 3   t_ratio 0.5517786   0.001
...
write.csv(t(arc$S), '../../out/cell-lines/ParetoTI/S.csv')
write.csv(arc$S, '../../out/RPM-time-series/ParetoTI/S.csv')

##################################

load(file="../../out/cell-lines/ParetoTI/arc.Robj")
load( file="../../out/cell-lines/ParetoTI/arc_rob.Robj")
load( file="../../out/cell-lines/ParetoTI/arc_ave.Robj")
```
...
data_attr = merge_arch_dist(arc_data = arc_ave, data = x_pca, 
                            feature_data = as.matrix(rna),
                            # colData = activ_pi, 
                            dist_metric = c("euclidean", "arch_weights")[1],
                            colData_id = "cells", rank = F) 
save(data_attr, file="../../out/cell-lines/ParetoTI/data_attr.Robj")
# distances = data_attr$data[,c('sample_id','archetype_1','archetype_2','archetype_3','archetype_4')]
# write.csv(distances, '../../out/cell-lines/ParetoTI/distances.csv')
