---
title: "Single Cell SCLC TKO Tumor Archetypes"
output:
  html_document:
    df_print: paged
---
...
Reading in preprocessed (MAGIC imputed) data from from `2-TKO_tumors_scPCHA.ipynb`

```{r message = FALSE}
file = "../../out/TKO-tumors/X_magic_for_R.h5ad"
Convert(file, dest = "h5seurat", overwrite = TRUE)
data <- LoadH5Seurat("../../out/TKO-tumors/X_magic_for_R.h5seurat")
...
VlnPlot(data, features = c("Ascl1", "Yap1", 'Calca','Neurod2', 'Myc', 'Rest'), combine = FALSE)
```
...
save(data, file="../../out/TKO-tumors/ParetoTI/X_magic_for_ParetoTI.Robj")

write.csv(data[["RNA"]]@scale.data, '../../out/TKO-tumors/ParetoTI/integrated-corrected-data.csv')
write.csv(data[['pca']]@cell.embeddings, '../../out/TKO-tumors/ParetoTI/pca_embedding.csv')
write.csv(data[['pca']]@feature.loadings, '../../out/TKO-tumors/ParetoTI/pca_feature_loadings.csv')

data <- ProjectDim(data, reduction = 'pca')
write.csv(data[['pca']]@feature.loadings.projected, '../../out/TKO-tumors/ParetoTI/pca_feature_loadings_projected.csv')
...
##################################
load(file="../../out/TKO-tumors/ParetoTI/X_magic_for_ParetoTI.Robj")

x <- data[["RNA"]]@scale.data

x_pca <- read.csv('../../out/TKO-tumors/ParetoTI/pca_embedding.csv',header = TRUE,row.names = 1)
x_pca <- t(x_pca)

x_pca <- x_pca[1:16,] #keep only top 11 PCs
loadings<- read.csv('../../out/TKO-tumors/ParetoTI/pca_feature_loadings.csv', header = TRUE, row.names = 1)
...
pdf(sprintf('../../figures/ParetoTI/TKO-tumors/%s_t-ratio_test.pdf', i))
...
# 1: 3   varexpl 0.6562396   0.990
# 2: 3   t_ratio 0.3315871   0.999
# 3: 3 total_var        NA     NaN
# 
#    k  var_name   var_obs p_value
# 1: 4   varexpl 0.7203730   0.339
# 2: 4   t_ratio 0.2120944   0.001
# 3: 4 total_var        NA     NaN
#    k  var_name    var_obs p_value
# 1: 5   varexpl 0.77132954   0.438
# 2: 5   t_ratio 0.07308685   0.001
...
arc_rob = fit_pch_bootstrap(x_pca, n = 200, sample_prop = .8, seed = 2543, delta = 1, noc = 4)
arc_ave <- average_pch_fits(arc_rob)
save(arc, file="../../out/TKO-tumors/ParetoTI/arc.Robj")
save(arc_rob, file="../../out/TKO-tumors/ParetoTI/arc_rob.Robj")
save(arc_ave, file="../../out/TKO-tumors/ParetoTI/arc_ave.Robj")
write.csv(arc$XC, file="../../out/TKO-tumors/ParetoTI/arc_positions_pca.csv")
write.csv(arc_ave$XC, file="../../out/TKO-tumors/ParetoTI/arc_ave_positions_pca.csv")

reconstruct_from_pca <- function(x, loadings, arc_XC, nComp = 16){
...
write.csv(t(arc_genespace), '../../out/TKO-tumors/ParetoTI/arc_gene-space.csv')
##################################

load(file="../../out/TKO-tumors/ParetoTI/arc.Robj")
load( file="../../out/TKO-tumors/ParetoTI/arc_rob.Robj")
load( file="../../out/TKO-tumors/ParetoTI/arc_ave.Robj")
write.csv(arc$S, '../../out/TKO-tumors/ParetoTI/S.csv')
...
htmlwidgets::saveWidget(p_pca, "../../figures/ParetoTI/TKO-tumors/robust_archetypes.html")
...
htmlwidgets::saveWidget(p_pca, "../../figures/ParetoTI/TKO-tumors/NEUROD2.HTML")
# 
...
# htmlwidgets::saveWidget(p_pca, "../../figures/ParetoTI/TKO-tumors/YAP1.html")
...
# htmlwidgets::saveWidget(p_pca, "../../figures/ParetoTI/TKO-tumors/POU2F3.html")
...
htmlwidgets::saveWidget(p_pca, "../../figures/ParetoTI/TKO-tumors/ASCL1.html")
...
save(data_attr, file="../../out/TKO-tumors/ParetoTI/data_attr.Robj")
...
write.csv(enriched_genes, '../../out/TKO-tumors/ParetoTI/enriched-genes.csv')
# 
# enriched_sets = find_decreasing_wilcox(data_attr$data, data_attr$arc_col,
#                                 features = data_attr$colData_col,
#                                 bin_prop = 0.05, method = "BioQC")
# write.csv(enriched_sets, '../../out/TKO-tumors/ParetoTI/enriched_sets.csv')
# 
