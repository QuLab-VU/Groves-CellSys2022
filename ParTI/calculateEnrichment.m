function [P]=calculateEnrichment(DataPoints,Archetypes,DiscFeatName,EnMatDis,ContFeatName,EnMatCont,binSize,OutputFileName,numIter,algNum,GOcat2Genes,DataPointsOrg,evalPmax)
...
[continuousTable, ~, ~, ~, P]= ContinuousEnrichment(orderedIndices,EnMatCont,binSize); 
